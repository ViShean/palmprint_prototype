...
set_target_properties(gloo PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "/media/nvidia/NVME/pytorch/pytorch-v1.10.0/torch/lib/libgloo.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS gloo )
list(APPEND _IMPORT_CHECK_FILES_FOR_gloo "/media/nvidia/NVME/pytorch/pytorch-v1.10.0/torch/lib/libgloo.a" )
...
set_target_properties(gloo_cuda PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "/media/nvidia/NVME/pytorch/pytorch-v1.10.0/torch/lib/libgloo_cuda.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS gloo_cuda )
list(APPEND _IMPORT_CHECK_FILES_FOR_gloo_cuda "/media/nvidia/NVME/pytorch/pytorch-v1.10.0/torch/lib/libgloo_cuda.a" )
